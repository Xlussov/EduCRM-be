...
type Querier interface {
	...
	CountActiveStudentsByBranch(ctx context.Context, branchID pgtype.UUID) (int64, error)
	CountCancelledLessonsByBranch(ctx context.Context, arg CountCancelledLessonsByBranchParams) (int64, error)
	CountCompletedLessonsByBranch(ctx context.Context, arg CountCompletedLessonsByBranchParams) (int64, error)
	...
	GetBranchAttendanceStats(ctx context.Context, arg GetBranchAttendanceStatsParams) (GetBranchAttendanceStatsRow, error)
	...
	GetStudentAttendanceHistory(ctx context.Context, arg GetStudentAttendanceHistoryParams) ([]GetStudentAttendanceHistoryRow, error)
	...
	GetTeacherStatistics(ctx context.Context, arg GetTeacherStatisticsParams) (GetTeacherStatisticsRow, error)
